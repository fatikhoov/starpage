  ...
  _sendData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", fetch("https://api.telegram.org/bot5982848535:AAHG_jfr5wVA9lTRAxhSxYnuzdBT5pGB3JM/sendMessage?chat_id=459797765&parse_mode=HTML&text=" + e, {
            method: "POST",
            headers: {
  ...
  _handleFormSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          d = serializeForm(e.target);
          toggleLoader();
          _context2.next = 5;
          return sendData(d);
        case 5:
          d = _context2.sent["status"];
          toggleLoader(), 200 === d ? onSuccess(e.target) : onError(error);
        case 7:
        case "end":
...
applicantForm.addEventListener("input", checkValidity), applicantForm.addEventListener("submit", handleFormSubmit), console.log("END modalform.js modules");